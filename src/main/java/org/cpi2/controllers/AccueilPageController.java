...
public class AccueilPageController implements Initializable {
    ...
    private void loadUpcomingSessions() {
        try {
            ...
            // Get upcoming sessions from database directly
            List<Seance> upcomingSessions = new ArrayList<>();

            try {
                // Direct database query to get upcoming sessions
                ...
                java.sql.Connection conn = java.sql.DriverManager.getConnection("jdbc:mysql://localhost:3306/autoecole", "root", "");
    ...
    private void setupDashboardCards() {
        try {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    if (rs.wasNull()) {
                        ...
                        String fallbackQuery = "SELECT COUNT(*) FROM examen WHERE resultat = 1";
            ...
            try {
                ...
                String queryAvailable = "SELECT COUNT(*) FROM vehicule WHERE statut = 'Disponible'";
    ...
    private void setupProgressionChart() {
        try {
            ...
            try {
                ...
                String sessionsQuery = "SELECT MONTH(date) AS month, COUNT(*) AS count " +
                        "FROM seance " +
                ...
                String registrationsQuery = "SELECT MONTH(DATE(created_at)) AS month, COUNT(*) AS count " +
                        "FROM candidat " +
